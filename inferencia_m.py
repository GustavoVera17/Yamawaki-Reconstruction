...
def main():
    ...
    # 1. Ruta exacta del modelo .pth que quieres usar
    RUTA_MODELO_PTH = r"C:\CODE2026\CASSIproy2026\CASSIproy2026\Yamawaki_Rep\checkpoints\yamawaki_epoch_100.pth"
    ...
    banda_inicial = 18 # Empezamos cerca de los 580nm
    ...
    img_error_plot = axes[3].imshow(error_inicial, cmap='inferno', vmin=0, vmax=0.2) 
